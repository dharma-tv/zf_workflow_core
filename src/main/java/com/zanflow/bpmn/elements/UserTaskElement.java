...
public class UserTaskElement extends BasicElement
{
	...
	{
		BPMNTask task=createTask(objBPMNData,getObjElementModelInstance().getDomElement().getAttribute("id"),stringParam2,"userTask",1);
		return task;
	}
