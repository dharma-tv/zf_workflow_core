package com.zanflow.bpmn.exception;
...
public class ApplicationException extends Exception {
	...
	//Sonar Fix:: Added new Constructor to retain the stack trace : START 
	public ApplicationException(Exception e,String msg) {
		message=msg+"#"+e.getMessage();
	}
	//Sonar Fix:: Added new Constructor to retain the stack trace : END 
